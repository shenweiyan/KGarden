![ssl.jpg](https://cdn.nlark.com/yuque/0/2020/jpeg/126032/1592469467116-1dde6fa3-e29f-41db-95ec-6eb00064818f.jpeg#align=left&display=inline&height=336&originHeight=336&originWidth=765&size=84520&status=done&style=none&width=765)
...
![gdc-server-down.png](https://cdn.nlark.com/yuque/0/2020/png/126032/1591863541443-903e7a81-8a24-4c6b-a3b9-06dc92239292.png#align=left&display=inline&height=591&originHeight=591&originWidth=702&size=35737&status=done&style=none&width=702)
...
![google-gdc-error.png](https://cdn.nlark.com/yuque/0/2020/png/126032/1591864057914-c287300c-4d30-445f-860f-d257d2a6b5f4.png#align=left&display=inline&height=617&originHeight=617&originWidth=881&size=77161&status=done&style=none&width=881)
然而这些方法都未能解决我的问题，于是乎有了下面的一些探索。

## 三、源码分析

首先，我去 TCGAbiolink 中的源码看这个异常是在哪里导致的，在 R/internal.R 中发现：
![get-gdc-info.png](https://cdn.nlark.com/yuque/0/2020/png/126032/1591864414494-0409f82e-a7eb-4419-9982-4451c23e8b16.png#align=left&display=inline&height=430&originHeight=430&originWidth=813&size=35528&status=done&style=none&width=813)
...
![curl-fail.png](https://cdn.nlark.com/yuque/0/2020/png/126032/1591865271401-156282ce-10e0-4d36-b80b-76608d8022ef.png#align=left&display=inline&height=496&originHeight=496&originWidth=833&size=45124&status=done&style=none&width=833)
...
![ca.png](https://cdn.nlark.com/yuque/0/2020/png/126032/1591866833953-e61c7534-cf4c-4d97-8e2b-f3ab16f9476f.png#align=left&display=inline&height=381&originHeight=381&originWidth=799&size=64219&status=done&style=none&width=799)
下载并绑定证书：
