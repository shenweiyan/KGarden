...
![](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fpq9ObNYavMIyXe5rmYWRmGLBNDw.png)
...
![jupyterlab-with-ip.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FqhJp4xMpbPY3IB4o8VQOYW9RjPg.png)
JupyterLab 各种 Conda 环境与语言版本

这样就可以在单一一个 JupyterLab 界面中同时使用不同 Conda 环境下的各种语言与版本了。
![jupyterlab-multi-env.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FhU7QRtOnp-HFCm1VQwT1Mme44P3.png)
...
![jupyter-lab.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FtVANgfX9_hkr7wXWf9zHQgVOSMo.png)
...
![jupyterlab-domain.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fuau3xcI0zxDGpwoDM__RS-Xe-l5.png)
