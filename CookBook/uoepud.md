...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FuLbjZTWqApeI_8dmyUAEfUhOqac.png)
...
![aaa1.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Ful5yh4GHKvGlIxi70EFnN6L3MeE.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FlV7P7YtH_2WQMsxZldbo5KXBcHf.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fm22JgSMAVB9b5lwJs2XdDWduzDQ.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fhx-0wk1Ni1mjMyVt78if2nSYM69.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FiSBcqyBZkTABEShIaxPIN-7yu83.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fv8a1wLrg0-Dlt-AKQFlg1GPRYaR.png)

```r
image_scale(frink, "x300") # height: 300px
```

![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FjPECLff8hjyjbJccC7d7f224S7l.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FtqDPXmQacO5yg1EZiEbpwyG2q4e.png)

```r
image_flip(frink)
```

![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FqnFMwS6VU9CneuQxOfmENoymNuZ.png)

```r
image_flop(frink)
```

![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FtimRQfjHX87iVIUFUk4s-LX4Phl.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FvrrMzE6tH0JlZx5hfzfUWfs6Y1E.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FluuWhblbeTFArHfOR_XJZkWa31t.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FqSBckuFlA9keFFc9QPS8KYV_n-J.png)

```r
image_noise(frink)
```

![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fm4E54Q30efRLgpkqkDDnYW-qVSa.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FkwXd6SStEoUDHVr4e4JQrLw-Eod.png)

```r
image_oilpaint(frink)
```

![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FmTdWz7FhwrY34RFnZYX7s2qesY0.png)

```r
image_negate(frink)
```

![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fh0FBHPspS1QXE7_CUk1ZXveJ4Zi.png)
...
![image.gif](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FtHductdc0XNwIuBIU9FXK5rsupQ.gif)
...
![image.gif](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FoMamLgClJsXl-uY4LIEKg-qqigu.gif)

```r
img %>% image_convolve('DoG:0,0,2') %>% image_negate()
```

![image.gif](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FoLfKyxFDjLDaiCljebugew_HJNX.gif)
...
![bioinit.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FghbpybZdHGe8qiWvybFp8kx-TSA.png)
...
![preview.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fj1tPMGunbPzMECKBpX8O9HB8y_u.png)
...
![he.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FpjTastp1y53grVXsxWC88FR_BbU.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FiZaDDUtB1k9p62GOCPussr6Gfyp.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FmcKRSe3mMoK9MN95raRD49ud1lZ.png)
...
![image.gif](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fpa3AW70VCwbjcfCX1WhsEtPew8T.gif)
...
![image.gif](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FlYafL-QG-ZIglCUtvU4JbtwSBns.gif)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FlrHVyMABla_IaW2H5Lg7u5hFhGg.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FtKu0aAfNLknk0XBsGoYQg51kuxP.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fv_TlL5Et38wV_iwCH8v4TmNDbPH.png)

```r
image_flatten(img, 'Modulate')
```

![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FuitoCzoSHeNEveFBN15yg2kGm45.png)

```r
image_flatten(img, 'Minus')
```

![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FuhGpcsil9xtxh0twGNC5GnzO8L4.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FtxpdQkHZFwzkLBJgahib9MT_4nF.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FhMVlwTnOjh9yUkQtlMPi5Od6NF_.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FkOEAsghPH7_g7BKUJdGWhefsNsT.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fu_HHq0k0faj2Ykl3CMnW2PvcEbZ.png)
...
![image.gif](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FvQD-fSNeprbTsmi5Y6xj7UZ3SSG.gif)
...
![image.gif](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fs0Fqy5mNgieuIAqqP5SyRCcaUjQ.gif)
...
![image.gif](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FjHQESx0Dsy7q8otiCpbGA0kpMQ7.gif)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FkDdPqcnq84W9woFJ-B_ftetqlfH.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FgRXn3ahO3jSVUf3HavycJkSQDN9.png)
...
![image.gif](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FmnLc502JTXejGFx4lRklxXWcfLH.gif)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Foylwf9AX4zNBs0JGF4rHbQU5KdW.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FsLD8uRNCnhiVMS-8fYZ2as4aRa6.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FjD7xj3dzxfoQUKjtTpZFXXTHvf_.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/FlxSnpf3uVblq7UZ6DWy39UJKFrk.png)
...
![image.png](https://shub-1251708715.cos.ap-guangzhou.myqcloud.com/elog-docs-images/Fl0CF7q5gK6U-qs6AQnC8ZbOa1SO.png)
