...
>
> _Note: MRO means _**_Microsoft R Open_**_ (previously _**_Revolution R)_** > **Recently I tried to set up the R development environment on a fresh Linux system, every thing went well until I hit this error installing xgboost:
