...
var getFileTypeFromBuffer = (buffer) => {
  return _imagesize2.default.call(void 0, buffer).type;
};
...
var getSecretExt = (config) => __async(void 0, null, function* () {
  _shared.out.access("\u6CE8\u610F", "\u6B63\u5728\u4F7F\u7528\u5BC6\u94A5\u62D3\u5C55\u70B9\uFF0C\u8BF7\u9075\u5FAA\u5BC6\u94A5\u62D3\u5C55\u70B9\u6CE8\u5165\u89C4\u8303");
  try {
  ...
  hasImage(fileName) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        _shared.out.debug(`\u4E0A\u4F20\u56FE\u7247\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5: ${e.message}`);
        return void 0;
      }
    });
  }
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (base64File) {
          ...
          _shared.out.warning("NOT FOUND", e.message);
        }
      }
    });
  }
...
var CosClient2 = class {
  ...
  uploadImg(imgBuffer, fileName) {
    return __async(this, null, function* () {
      try {
        const dirPath = _path2.default.resolve(process.cwd(), this.config.outputDir);
        _mkdirp2.default.sync(dirPath);
        const filePath = _path2.default.resolve(dirPath, fileName);
...
var ImgBedClient = class {
  ...
  getImageBedInstance(platform) {
    if (!imageBedList.includes(platform)) {
      _shared.out.err("\u914D\u7F6E\u9519\u8BEF", `\u76EE\u524D\u53EA\u652F\u6301${imageBedList.toString()}`);
      process.exit(-1);
    }
    switch (platform) {
      case "cos" /* COS */:
...
var ImageUploader = class {
  ...
  getPicBufferFromURL(url) {
    return __async(this, null, function* () {
      try {
        const res = yield _shared.request.call(void 0, url, {
        ...
        _shared.out.info("\u4E0B\u8F7D\u6210\u529F", url);
        return res.data;
      } catch (e) {
        _shared.out.warning("\u4E0B\u8F7D\u5931\u8D25", `${url}\uFF0C\u9519\u8BEF\u4FE1\u606F\uFF1A${e.message}`);
      }
    });
  }
  /**
      ...
      const toUploadURLs = urlList.map((image) => __async(this, null, function* () {
        return yield new Promise((resolve) => __async(this, null, function* () {
          try {
            ...
            _shared.out.info("\u5904\u7406\u56FE\u7247", `\u751F\u6210\u6587\u4EF6\u540D: ${fullName}`);
            let exist = yield this.ctx.hasImage(fullName);
            if (exist) {
              _shared.out.info("\u5FFD\u7565\u4E0A\u4F20", exist);
              resolve({
                fileName: fullName,
