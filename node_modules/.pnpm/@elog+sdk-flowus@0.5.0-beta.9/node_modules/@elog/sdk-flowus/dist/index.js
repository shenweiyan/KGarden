  ...
  return docs.sort((a, b) => {
    if (sorts) {
      ...
      if (Number.isNaN(Number(aSortValue)) || Number.isNaN(Number(bSortValue))) {
        if (_moment2.default.call(void 0, aSortValue).isValid() && _moment2.default.call(void 0, bSortValue).isValid()) {
          aSortValue = _moment2.default.call(void 0, aSortValue).valueOf();
          bSortValue = _moment2.default.call(void 0, bSortValue).valueOf();
        } else {
          return -1;
        }
      } else {
...
var FlowUsClient = class {
  ...
  getPageDetailList(cachedPages, ids) {
    return __async(this, null, function* () {
      ...
      yield _tinyasyncpool2.default.call(void 0, 5, pages, promise);
