...
var out = {
  ...
  debug(head, content) {
    _process2.default.env.DEBUG && println(4 /* DEBUG */, head, content);
  }
};
var out_default = out;
...
exports.BlockType = BlockType; exports.BlockTypeText = BlockTypeText; exports.HttpClientResponse = _urllib.HttpClientResponse; exports.RequestOptions = _urllib.RequestOptions; exports.out = out_default; exports.request = request;
