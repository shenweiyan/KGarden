...
var formatMarkdown = (content) => {
  return _prettier2.default.format(content, { parser: "markdown" });
};
var formatHtml = (content) => {
  return _prettier2.default.format(content, {
    parser: "html"
  });
};
...
function matterMarkdownAdapter(post) {
  ...
  try {
    ...
    _shared.out.warning(`\u3010${post.properties.title}\u3011Front matter \u751F\u6210\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u6587\u6863\u5C5E\u6027`);
  }
...
exports.htmlAdapter = htmlAdapter; exports.markdownAdapter = markdownAdapter; exports.matterMarkdownAdapter = matterMarkdownAdapter; exports.wikiAdapter = wikiAdapter;
